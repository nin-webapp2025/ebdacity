      ...
      <div className="footer-cta">
        <div className="footer-cta__inner">
          <div className="footer-cta__text">
            <p className="footer-cta__eyebrow">Limited Investment Opportunity</p>
            <h2 className="footer-cta__headline">Ready to invest in the <span>future?</span></h2>
          </div>
          <a href="#invest" className="footer-cta__btn">Invest Now</a>
        </div>
      </div>
      ...
      <footer className="footer" id="contact">
          ...
          <div className="footer__inner">
            ...
            <div className="footer__brand">
              ...
              <div className="footer__contact-details">
                <a href="https://wa.me/2349162699999" className="footer__contact-item" target="_blank" rel="noopener noreferrer">
                ...
                <a href="mailto:media@ebdacity.com" className="footer__contact-item">
                  <span className="footer__contact-icon">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer__bottom">
          <div className="footer__bottom-inner">
            <p className="footer__copyright">©{new Date().getFullYear()} EBDA City. All rights reserved.</p>
            <p className="footer__motto">The Future of Living and Industry.</p>
          </div>
        </div>
      </footer>
    </>
